...
-on the Groups card tab on the Data Tables page, only include these columns: Groups, and Modified Date; The Add Group pop up page should include these text fields: Group; the Edit Group pop up page should include these text fields: Group